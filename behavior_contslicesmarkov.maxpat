        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "int", "int" ],
                    "patching_rect": [ 182.0, 316.0, 48.0, 22.0 ],
                    "text": "change"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "float" ],
                    "patching_rect": [ 182.0, 292.0, 81.0, 22.0 ],
                    "text": "snapshot~ 10"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 180.75, 235.0, 50.5, 22.0 ],
                    "text": "t i i i b"
                }
            },
            {
            ...
            },
            {
                "box": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 56.0, 229.0, 35.0, 22.0 ],
                                    "text": "out 1"
                                }
                            }
                        ],
                    ...
                    "patching_rect": [ 182.0, 264.0, 36.0, 22.0 ],
                    "text": "gen~"
                }
            },
            {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 44.0, 375.0, 114.0, 375.0, 114.0, 264.0, 168.0, 264.0, 168.0, 240.0, 190.25, 240.0 ],
                    "order": 0,
                    "source": [ "obj-30", 0 ]
                }
            },
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 190.25, 270.0, 191.5, 270.0 ],
                    "source": [ "obj-37", 0 ]
                }
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 221.75, 279.0, 445.5, 279.0 ],
                    "source": [ "obj-37", 3 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 192.65677642822266, 375.0, 142.5, 375.0 ],
                    "source": [ "obj-40", 0 ]
                }
            },
            {
