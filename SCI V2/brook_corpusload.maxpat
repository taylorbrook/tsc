...
,
		"classnamespace" : "box",
		"rect" : [ -1744.0, 285.0, 1268.0, 589.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 441.75, 240.0, 42.0, 22.0 ],
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 189.0, 46.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 394.0, 154.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 394.0, 90.5, 90.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 394.0, 122.5, 239.0, 22.0 ],
					"text" : "fluid.concataudiofiles @destination #1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 487.5, 90.5, 94.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 59.0, 126.0, 135.0, 22.0 ],
					"text" : "buffer~ #1 #2"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 198.5, 87.0, 257.5, 87.0 ],
					"order" : 3,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 198.5, 78.0, 198.5, 78.0 ],
					"order" : 4,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 198.5, 111.0, 243.0, 111.0, 243.0, 123.0, 381.0, 123.0, 381.0, 195.0, 403.5, 195.0 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 212.5, 258.0, 426.0, 258.0, 426.0, 234.0, 451.25, 234.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 462.75, 264.0, 519.0, 264.0 ],
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 451.25, 264.0, 451.25, 264.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 474.25, 264.0, 408.0, 264.0, 408.0, 327.0, 309.5, 327.0 ],
					"source" : [ "obj-20", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 184.5, 186.0, 176.75, 186.0 ],
					"order" : 1,
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 184.5, 165.0, 370.5, 165.0 ],
					"order" : 0,
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 184.5, 186.0, 68.5, 186.0 ],
					"order" : 2,
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 403.5, 147.0, 403.5, 147.0 ],
					"source" : [ "obj-48", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 403.5, 78.0, 403.5, 78.0 ],
					"source" : [ "obj-52", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 403.5, 180.0, 369.0, 180.0, 369.0, 156.0, 297.0, 156.0, 297.0, 186.0, 68.5, 186.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 403.5, 114.0, 390.0, 114.0, 390.0, 84.0, 497.0, 84.0 ],
					"source" : [ "obj-80", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 497.0, 114.0, 403.5, 114.0 ],
					"source" : [ "obj-86", 0 ]
				}
